<div class="col-lg-12">
						...
						<div class="panel panel-flat">
							<div class="panel-heading">
								<h5 class="panel-title">Delivery for today <?= date('M j, Y'); ?></h5>
							</div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                               ...
                                               <!-- <button type="submit" value="export" name="btnFilterSearch" class="btn bg-success-600 btn-raised btn-xs">Export</button>	-->
                                            </div>
                                        </div>	
                                    </div>
								<?php echo form_close(); ?>
                                ...
                                ?>
                                    <tr>
                                        <td>
                                            <ul class="icons-list">
												<li>
													<a data-toggle='modal' data-target='#modal_details_report' data-rowid='<?= $row->Deliver_ID; ?>' data-rdate='<?= $row->ReceivedDate; ?>' data-popup='tooltip' title='View' data-placement='right'>
														<i class="icon-eye8"></i>
													</a>
                                                </li>
                                                <?php
